(function() {
    ...
    function insertLogo(renderElement, logoPath, fromCache) {
        ...
        var logoImg = $(`<img class="logo-img" style="display: block; max-height: 8em; max-width: 30vw; margin-top: 0em; margin-bottom: 0em; align-self: center;" src="${Lampa.TMDB.image("/t/p/w500" + logoPath)}">`);
