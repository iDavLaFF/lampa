/**
 * plugins/logo.js — добавление логотипов TMDB на экран "Полная карточка".
 * Поведение: ищет логотипы в TMDB с приоритетом текущего языка, fallback на en,
 * кэширует путь к логотипу в localStorage на 30 дней и плавно анимирует появление.
 */
(function() {
    "use strict";
