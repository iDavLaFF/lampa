(function() {
    ...
    function insertTextFallback(renderElement, title) {
        ...
        titleText.css({'font-size': '3em', 'font-weight': '100', 'text-align': 'center', 'color': '#fff', 'text-shadow': '0 2px 10px rgba(0,0,0,0.6)', 'max-width': '50vw', 'margin-top': '0em', 'margin-bottom': '0em', 'opacity': '0', 'transform': 'translateY(20px)', 'transition': 'all 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275)'});
