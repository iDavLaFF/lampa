(function () {
    ...
    var Defined = {
      use_api: 'lampac',
      localhost: 'https://idavlaff.github.io/lampa/plugins/sisi.json',
      vip_site: '',
      framework: ''
    };
    ...
    function ApiHttp() {
      ...
      this.account = function (u) {
		...
		if (uid) {
		  if (u.indexOf('uid=') == -1) u = Lampa.Utils.addUrlComponent(u, 'uid=' + encodeURIComponent(uid));else u = u.replace(/uid=[^&]+/, 'uid=' + encodeURIComponent(uid));
        }
