(function() {
    ...
    function vka4start() {
        ...
        var mult = $('<li class="menu__item selector" data-action="hd"><div class="menu__ico">' + ico + '</div><div class="menu__text">В качестве</div></li>');
    ...
    function vka5start() {
        var mult = $('<li class="menu__item selector" data-action="okko"><div class="menu__ico">' + icon + '</div><div class="menu__text">Okko</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka6start() {
        var mult = $('<li class="menu__item selector" data-action="ivi"><div class="menu__ico">' + icon + '</div><div class="menu__text">ИВИ</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka7start() {
        var mult = $('<li class="menu__item selector" data-action="wink"><div class="menu__ico">' + icon + '</div><div class="menu__text">Wink</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka8start() {
        var mult = $('<li class="menu__item selector" data-action="kion"><div class="menu__ico">' + icon + '</div><div class="menu__text">KION</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka9start() {
        var mult = $('<li class="menu__item selector" data-action="kion"><div class="menu__ico">' + icon + '</div><div class="menu__text">Netflix</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka3start() {
        var mult = $('<li class="menu__item selector" data-action="rus"><div class="menu__ico">' + icon + '</div><div class="menu__text">Русские</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka10start() {
        var mult = $('<li class="menu__item selector" data-action="rus"><div class="menu__ico">' + icon + '</div><div class="menu__text">Дорамы</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka11start() {
        var mult = $('<li class="menu__item selector" data-action="kp"><div class="menu__ico">' + icon + '</div><div class="menu__text">Кинопоиск</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka13start() {
        ...
        var mult = $('<li class="menu__item selector" data-action="mult2"><div class="menu__ico">' + iconm + '</div><div class="menu__text">Мультсериалы</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka12start() {
        var iconm = '<svg viewBox="0 0 514 514" xmlns="http://www.w3.org/2000/svg"><path d="m400 2c-79 6-142 75-142 156v14h-99l-98 1-5 2c-38 17-23 63 21 65h15l-3 6c-10 20-10 24-11 76v45l-5-8c-7-12-13-26-18-39-5-15-6-17-11-21-13-12-35-7-41 10-6 16 17 70 46 105 116 145 347 127 439-34 31-54 31-87-1-87-15 0-21 5-28 27-6 18-28 58-31 58-1 0-1-22-1-49v-50l-11-55c-12-60-12-58-6-63 8-7 15-3 24 11 14 24 29 30 47 21 20-9 21-17 10-71-10-52-10-53 2-53s21-14 20-28c-1-6-2-7-10-13-30-20-65-29-103-26m43 74c-10 3-14 17-6 25 13 13 32-4 23-19-3-5-11-8-17-6m-289 114v27l1 26 2 3 3 3h46 46l3-3 2-3v-27-27h-51c-36 0-51 0-52 1m78 116c-54 9-96 54-102 109l-1 6 10 6c70 45 158 47 230 4 9-5 8-4 7-15-7-71-73-122-144-110" fill="currentColor" fill-rule="evenodd"/></svg>';
        var mult = $('<li class="menu__item selector" data-action="mult3"><div class="menu__ico">' + iconm + '</div><div class="menu__text">Мультфильмы</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka15start() {
        var iconm = '<svg viewBox="0 0 514 514" xmlns="http://www.w3.org/2000/svg"><path d="m400 2c-79 6-142 75-142 156v14h-99l-98 1-5 2c-38 17-23 63 21 65h15l-3 6c-10 20-10 24-11 76v45l-5-8c-7-12-13-26-18-39-5-15-6-17-11-21-13-12-35-7-41 10-6 16 17 70 46 105 116 145 347 127 439-34 31-54 31-87-1-87-15 0-21 5-28 27-6 18-28 58-31 58-1 0-1-22-1-49v-50l-11-55c-12-60-12-58-6-63 8-7 15-3 24 11 14 24 29 30 47 21 20-9 21-17 10-71-10-52-10-53 2-53s21-14 20-28c-1-6-2-7-10-13-30-20-65-29-103-26m43 74c-10 3-14 17-6 25 13 13 32-4 23-19-3-5-11-8-17-6m-289 114v27l1 26 2 3 3 3h46 46l3-3 2-3v-27-27h-51c-36 0-51 0-52 1m78 116c-54 9-96 54-102 109l-1 6 10 6c70 45 158 47 230 4 9-5 8-4 7-15-7-71-73-122-144-110" fill="currentColor" fill-rule="evenodd"/></svg>';
        var mult = $('<li class="menu__item selector" data-action="mult3"><div class="menu__ico">' + iconm + '</div><div class="menu__text">Nickelodeon</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function vka16start() {
        var mult = $('<li class="menu__item selector" data-action="mult3"><div class="menu__ico">' + icon + '</div><div class="menu__text">Start</div></li>');
        mult.on('hover:enter', function() {
            Lampa.Activity.push({
    ...
    function multstart() {
        ...
        $('.menu .menu__list').eq(0).append(mult);
        setTimeout(function() {
            // $('[data-action=kp]').insertBefore($('[data-action=tv]'));
    ...
    function startPlugin() {
        ...
        function add() {
            if (!window.plugin_podbor_ready) {
                if (Lampa.Storage.get("porborki_kach") == '1')
                    vka4start();
                if (Lampa.Storage.get("porborki_rus") == '1')
                    vka3start();
                if (Lampa.Storage.get("porborki_okko") == '1')
                    vka5start();
                if (Lampa.Storage.get("porborki_ivi") == '1')
                    vka6start();
                if (Lampa.Storage.get("porborki_wink") == '1')
                    vka7start();
                if (Lampa.Storage.get("porborki_kion") == '1')
                    vka8start();
                if (Lampa.Storage.get("porborki_netflix") == '1')
                    vka9start();
                if (Lampa.Storage.get("porborki_kr") == '1')
                    vka10start();
                if (Lampa.Storage.get("porborki_kp") == '1')
                    vka11start();
                if (Lampa.Storage.get("porborki_mult12") == '1')
                    vka12start();
                if (Lampa.Storage.get("porborki_mult13") == '1')
                    vka13start();
                if (Lampa.Storage.get("porborki_mult14") == '1' || Lampa.Storage.get("porborki_mult14") != '0')
                    multstart();
                if (Lampa.Storage.get("porborki_mult15") == '1')
                    vka15start();
                if (Lampa.Storage.get("porborki_start") == '1')
                    vka16start();
                $('.head__title').html('Главная @lampa_land');
            }
            window.plugin_podbor_ready = true;
            if (location.hostname == 'lampa.land') {
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="mult"]').length == 0)
                            multstart();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                });
                Lampa.SettingsApi.addParam({
                    component: 'porborki_mult',
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="mult12"]').length == 0)
                            vka12start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="mult15"]').length == 0)
                            vka15start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="mult13"]').length == 0)
                            vka13start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="rus"]').length == 0)
                            vka3start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="hd"]').length == 0)
                            vka4start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="okko"]').length == 0)
                            vka5start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="kp"]').length == 0)
                            vka11start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="ivi"]').length == 0)
                            vka6start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="wink"]').length == 0)
                            vka7start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="kion"]').length == 0)
                            vka8start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="netflix"]').length == 0)
                            vka16start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    onChange: function(value) {
                        if (value == 1 && $('[data-action="kr"]').length == 0)
                            vka10start();
                        else
                            Lampa.Helper.show('Необходимо переоткрыть Lampa');
                    }
